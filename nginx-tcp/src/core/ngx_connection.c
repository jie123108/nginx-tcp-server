...
ngx_get_connection(ngx_socket_t s, ngx_log_t *log)
{
    ...
    ngx_atomic_fetch_add(&ngx_process_conn->conns,1);
    ngx_atomic_fetch_add(&ngx_conn_sum->conn_sum,1);
    //printf("new # pid:%d, total:%d, self:%d\n", (int)ngx_getpid(), 
	//			ngx_conn_sum->conn_sum, ngx_process_conn->conns);
    /* ngx_mutex_unlock */
...
ngx_free_connection(ngx_connection_t *c)
{
    ...
    ngx_atomic_fetch_add(&ngx_process_conn->conns,-1);
    ngx_atomic_fetch_add(&ngx_conn_sum->conn_sum,-1);
    //printf("free # pid:%d, total:%d, self:%d\n", (int)ngx_getpid(), 
	//			ngx_conn_sum->conn_sum, ngx_process_conn->conns);
